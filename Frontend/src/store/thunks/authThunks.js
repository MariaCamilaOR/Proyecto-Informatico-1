    ...
    return async (dispatch) => {
        ...
        try {
            ...
            try {
                ...
                console.warn('Failed to request claim assignment from backend:', err?.message || err);
            }
            await signOut(auth);
        }
        catch (e) {
...
export const registerWithGoogle = (role) => {
    return async (dispatch) => {
        dispatch(startLoading());
        try {
            ...
            try {
                ...
                // eslint-disable-next-line no-console
                console.warn('Failed to request claim assignment for google-registered user:', err?.message || err);
            }
            await signOut(auth);
